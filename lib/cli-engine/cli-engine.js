...
const {processOptions} = require("../eslint/eslint-helpers");
 ...
 * @property {boolean} [shareableCache] true makes the cache shareable with relative paths
...
class CLIEngine {
    ...
    constructor(providedOptions, { preloadedPlugins } = {}) {
        ...
        const lintResultCache =
            options.cache ? new LintResultCache(cacheFilePath, options.cacheStrategy, options.shareableCache, options.cwd) : null;
