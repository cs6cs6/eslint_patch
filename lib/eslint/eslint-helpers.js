...
function processOptions({
    ...
    plugins = {},
    ruleFilter = () => true,
    shareableCache = false, // ← should be false by default to avoid breaking older versions, since changing this changes the structure of the cache file on disk.
    warnIgnored = true,
    ...unknownOptions
}) {
    const errors = [];
    ...
    if (typeof shareableCache !== "boolean") {
        errors.push("'shareableCache' must be a boolean.");
    }
