 ...
 * @property {boolean} [shareableCache] Whether or not a cache can be shared with others, based on the way directories are storied in the cache file itself.
                ...
                return fs.readFile(filePath, "utf8")
                    .then(text => {
                        ...
                        if (lintResultCache) {
                            ...
                            let cacheFilePath = filePath;

                            if(processOptions.shareableCache){
                                // to make this shareable, use a partial path.
                                cacheFilePath = filePath.replace(cwd, '');
                            }

                            lintResultCache.setCachedLintResults(cacheFilePath, config, result);
                        }
